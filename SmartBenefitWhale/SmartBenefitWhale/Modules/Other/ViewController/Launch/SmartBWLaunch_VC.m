...
- (void)configAppInformation {
    ...
    [SmartBWAuxiliaryMeansManager deviceNetworkMonitorRemoveNotification];
    [SmartBWAuxiliaryMeansManager configUniversalNavigationBarAndTabBar];
...
//    [CAFNODataManager configDataManagerBasalSetting];
    ...
    NSMutableArray *labs = [NSMutableArray arrayWithObjects:@{@"vc":[SmartBWMain_VC new],@"title":@"首页",@"image_n":@"tab_0_n_mark",@"image_s":@"tab_0_s_mark"},@{@"vc":[SmartBWWelfare_VC new],@"title":@"青创",@"image_n":@"tab_1_n_mark",@"image_s":@"tab_1_s_mark"},@{@"vc":[SmartBWYouth_VC new],@"title":@"签到",@"image_n":@"tab_2_n_mark",@"image_s":@"tab_2_s_mark"},@{@"vc":[SmartBWShoppingCentre_VC new],@"title":@"商城",@"image_n":@"tab_3_n_mark",@"image_s":@"tab_3_s_mark"},@{@"vc":[SmartBWMine_VC new],@"title":@"我的",@"image_n":@"tab_4_n_mark",@"image_s":@"tab_4_s_mark"}, nil];
    [SmartBWTabBar configTabBarViewByItemTitles:@[@"首页",@"青创",@"签到",@"商城",@"我的"] firstIndex:FirstIndex];
